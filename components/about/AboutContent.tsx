...
import AboutStatsBarSkeleton from "@/components/about/AboutStatsBarSkeleton";
import { ABOUT_HERO_IMAGE_SIZES } from "@/lib/image-layout";
...
const AboutContent = () => {
  ...
  return (
    <main className="bg-white">
      ...
      <Suspense fallback={<AboutStatsBarSkeleton />}>
        <AboutStatsBar />
      </Suspense>
