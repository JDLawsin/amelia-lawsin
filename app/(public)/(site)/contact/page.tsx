...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Amelia Lawsin — free consultation via Messenger, WhatsApp, SMS, Viber or email. Licensed real estate agent in Cebu, Philippines. OFW specialist.",
  alternates: { canonical: "/contact" },
  openGraph: {
    title: "Contact Amelia Lawsin — Real Estate Agent Cebu",
    description:
      "Free consultation via Messenger, WhatsApp, SMS, Viber or email. Licensed agent in Cebu, Philippines.",
    type: "website",
...
const CHANNELS = [
  ...
  {
    title: "WhatsApp",
    description: "Popular with OFWs and quick mobile chats",
    href: whatsappUrl ?? "#",
    external: true,
    primary: false,
    icon: (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-wire">
        <div className="px-6 lg:px-12 py-12">
          ...
          <div className="mb-8 max-w-sm">
            <ScheduleViewingButton source="Contact page" variant="primary" />
          </div>
          <InquiryFormLoader />
        </div>
